...
-- Executar o resto do script de criação das tabelas
...
-- Voltar ao postgres e marcar como template
\c postgres;

-- Marcar o banco como template
UPDATE pg_database SET datistemplate = true WHERE datname = 'house_template';
